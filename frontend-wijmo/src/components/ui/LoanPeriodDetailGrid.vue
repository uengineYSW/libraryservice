<template>
    <div>
        ...
        >
            ...
            <wj-flex-grid-column binding="periodInDays" header="PeriodInDays" width="2*" :isReadOnly="true" align="center">
                <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
                    <Number v-model="cell.item.periodInDays" :editMode="editMode"/>
