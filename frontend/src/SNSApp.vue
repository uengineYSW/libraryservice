            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="bookDetails"
                        to="/bookManagements/bookDetails"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="loanHistories"
                        to="/loanmanagements/loanHistories"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="loanDetails"
                        to="/loanmanagements/loanDetails"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '도서', 
                description: 'Book을 관리하는 화면입니다.', 
                key: 'books', 
                route: '/bookManagements/books',
                ImageUrl: '',
            },
            { 
                title: '도서 대출', 
                description: 'Loan을 관리하는 화면입니다.', 
                key: 'loans', 
                route: '/loanmanagements/loans',
                ImageUrl: '',
            },
            { 
                title: '도서 목록', 
                description: 'BookList을 관리하는 화면입니다.', 
                key: 'bookLists', 
                route: '/bookManagements/bookLists',
                ImageUrl: '',
            },
            { 
                title: '도서 상세 정보', 
                description: 'BookDetails을 관리하는 화면입니다.', 
                key: 'bookDetails', 
                route: '/bookManagements/bookDetails',
                ImageUrl: '',
            },
            { 
                title: '대출 이력', 
                description: 'LoanHistory을 관리하는 화면입니다.', 
                key: 'loanHistories', 
                route: '/loanmanagements/loanHistories',
                ImageUrl: '',
            },
            { 
                title: '대출 상세', 
                description: 'LoanDetails을 관리하는 화면입니다.', 
                key: 'loanDetails', 
                route: '/loanmanagements/loanDetails',
                ImageUrl: '',
            },
